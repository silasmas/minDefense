...
namespace App\Filament\Resources\VeteranAssetResource\RelationManagers;
...
class LogsRelationManager extends RelationManager
{
    ...
    {
        return $form->schema([
            Forms\Components\Select::make('event_type')->label('Type d’événement')->options([
                'maintenance'=>'Maintenance','inspection'=>'Inspection','transfer'=>'Transfert',
                'status_change'=>'Changement de statut','note'=>'Note',
            ...
            Forms\Components\DateTimePicker::make('occurred_at')->label('Date / heure')->default(now()),
    ...
    public function table(Tables\Table $table): Tables\Table
    {
        return $table
            ->columns([
                Tables\Columns\BadgeColumn::make('event_type')->label('Type')->colors([
                    'info'=>'maintenance','warning'=>'inspection','primary'=>'transfer','gray'=>'status_change'
                ]),
            ...
            ->headerActions([
                Tables\Actions\CreateAction::make()->label('Ajouter une ligne'),
            ])
            ->actions([
